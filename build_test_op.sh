...
echo $OP_SUBMISSION_VAR04_FILE
echo $OP_SUBMISSION_VAR05_FILE
echo $OP_SUBMISSION_VAR06_FILE
echo $CC
echo $CFLAGS
...
${CC} ${CFLAGS} ${TEST_RIG}.o ${OP_BASELINE_FILE}.ref.o ${OP_SUBMISSION_VAR04_FILE}.o -o ./run_test_op_var04.x
${CC} ${CFLAGS} ${TEST_RIG}.o ${OP_BASELINE_FILE}.ref.o ${OP_SUBMISSION_VAR05_FILE}.o -o ./run_test_op_var05.x
${CC} ${CFLAGS} ${TEST_RIG}.o ${OP_BASELINE_FILE}.ref.o ${OP_SUBMISSION_VAR06_FILE}.o -o ./run_test_op_var06.x
