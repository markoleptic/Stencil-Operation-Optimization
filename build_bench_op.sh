...
${CC} ${CFLAGS} ${TEST_RIG}.o ${OP_SUBMISSION_VAR04_FILE}.o -o ./run_bench_op_var04.x
${CC} ${CFLAGS} ${TEST_RIG}.o ${OP_SUBMISSION_VAR05_FILE}.o -o ./run_bench_op_var05.x
${CC} ${CFLAGS} ${TEST_RIG}.o ${OP_SUBMISSION_VAR06_FILE}.o -o ./run_bench_op_var06.x
