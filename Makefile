...
clean:
	rm -f *.x *~ *.o
	rm -f OpenMP_Threads/*.x OpenMP_Threads/*.o
...
run-bench-local: build-bench-local
	...
	./plotter_multi.py "Local Results of Stencil Computation" "PLOT_local.png" "result_bench_local_op_var01_k${KMEDIUM}.csv" "result_bench_local_op_var02_k${KMEDIUM}.csv" "result_bench_local_op_var03_k${KMEDIUM}.csv" "result_bench_local_op_var04_k${KMEDIUM}.csv"
